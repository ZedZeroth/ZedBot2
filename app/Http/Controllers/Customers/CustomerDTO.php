    ...
    \App\Http\Controllers\MultiDomain\Interfaces\ModelDtoInterface
{
    ...
    public function __construct(
        ...
        public ?string $sourceOfFiatFundsType,
        public ?string $sourceOfFiatFundsQuote,
        public ?string $sourceOfCvcFundsType,
        public ?string $sourceOfCvcFundsQuote,
        public ?string $destinationOfFiatFundsType,
        public ?string $destinationOfFiatFundsQuote,
        public ?string $destinationOfCvcFundsType,
        public ?string $destinationOfCvcFundsQuote,
